...
class ProgramRegion : public program::ProgramNode<ProgramRegion> {
 public:
  ...
  ProgramRegion(const TestAndSetRegion &);
...
class TestAndSetRegion : public program::ProgramNode<TestAndSetRegion> {
 public:
  static TestAndSetRegion From(ProgramRegion) noexcept;
 ...
 private:
  ...
  using program::ProgramNode<TestAndSetRegion>::ProgramNode;
};
...
class ProgramVisitor {
 public:
  ...
  virtual void Visit(TestAndSetRegion val);
