...
struct ColumnSerializer<Writer, ColumnDescriptor<kColId>> {
 public:
  ...
  HYDE_RT_FLATTEN HYDE_RT_INLINE static void WriteKey(Writer &writer,
                                                      const ColumnType &val) {
    Serializer<NullReader, Writer, ColumnType>::Write(writer, val);
  }

  HYDE_RT_FLATTEN HYDE_RT_INLINE static void WriteValue(Writer &writer,
                                                        const ColumnType &val) {
    Serializer<NullReader, Writer, ColumnType>::Write(writer, val);
  }
};
...
struct ColumnSerializer<Writer, KeyColumn<kColId>> {
 public:
  ...
  HYDE_RT_FLATTEN HYDE_RT_INLINE static void WriteValue(Writer &,
                                                        const ColumnType &val) {
  }
};
...
struct ColumnSerializer<Writer, Column, Columns...> {
 public:
  ...
  HYDE_RT_FLATTEN HYDE_RT_INLINE static void
  WriteKey(Writer &writer, const ColumnType &val,
