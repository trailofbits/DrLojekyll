...
static TypeKind TokToTypeKind(Token tok) noexcept {
  switch (tok.Lexeme()) {
    case Lexeme::kTypeBytes:
      return TypeKind::kBytes;
    case Lexeme::kTypeASCII:
      return TypeKind::kASCII;
    case Lexeme::kTypeUTF8:
      return TypeKind::kUTF8;
    case Lexeme::kTypeUUID:
      return TypeKind::kUUID;
    case Lexeme::kTypeIn:
      switch (tok.TypeSizeInBytes()) {
        case 1:
          return TypeKind::kSigned8;
        case 2:
          return TypeKind::kSigned16;
        case 4:
          return TypeKind::kSigned32;
        case 8:
          return TypeKind::kSigned64;
        default:
    ...
    case Lexeme::kTypeUn:
      switch (tok.TypeSizeInBytes()) {
        case 1:
          return TypeKind::kUnsigned8;
        case 2:
          return TypeKind::kUnsigned16;
        case 4:
          return TypeKind::kUnsigned32;
        case 8:
...
TypeLoc::TypeLoc(const Token &tok)
    : kind(TokToTypeKind(tok)), range(tok.SpellingRange()) {}
